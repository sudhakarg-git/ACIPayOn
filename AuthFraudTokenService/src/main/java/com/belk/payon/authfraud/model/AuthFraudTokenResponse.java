package com.belk.payon.authfraud.model;
...
public class AuthFraudTokenResponse {
	...
	public AuthFraudTokenResponse() {
	}

	public AuthFraudTokenResponse(String id, String paymentType, String amount, String currency, String descriptor,
			String merchantTransactionId, String merchantInvoiceId, Result result, ResultDetails resultDetaqils,
			CustomParameters customParameters, Risk risk, String buildNumber, Date timestamp, String ndc) {
		super();
		this.id = id;
